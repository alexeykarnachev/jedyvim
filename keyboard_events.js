/* 
 * This list was compiled from the UI Events KeyboardEvent key Values (W3C Candidate Recommendation, 01 June 2017),
 * available at https://www.w3.org/TR/uievents-key/. It was compiled by Aaron Greenlee, and originally published
 * at https://www.aarongreenlee.com/blog/list-of-non-printable-keys-for-keyboard-events-when-using-event-key/
 */

export const TYPE_TO_EVENT = {
    modifier: [
...
export const EVENTS = new Set(Object.values(TYPE_TO_EVENT).flat());


export function is_printable(key) {
